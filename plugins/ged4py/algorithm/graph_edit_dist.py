...
from plugins.ged4py.algorithm.abstract_graph_edit_dist import AbstractGraphEditDistance
from plugins.ged4py.algorithm.edge_edit_dist import EdgeEditDistance
from plugins.ged4py.graph.edge_graph import EdgeGraph
import sys
