...
# ======================== Data Setings ============================================
parser.add_argument('--dataset-test', type=str, default='MNIST', metavar='', help='name of training dataset')
parser.add_argument('--dataset-train', type=str, default='MNIST', metavar='', help='name of training dataset')
...
parser.add_argument('--dataroot', type=str, default='../', metavar='', help='path to the data')
...
parser.add_argument('--nchannels', type=int, default=1, metavar='', help='number of input channels')
parser.add_argument('--nfilters', type=int, default=8, metavar='', help='number of filters')
parser.add_argument('--resolution-high', type=int, default=28, metavar='', help='image resolution height')
parser.add_argument('--resolution-wide', type=int, default=28, metavar='', help='image resolution width')
...
parser.add_argument('--nepochs', type=int, default=3, metavar='', help='number of epochs to train')
...
parser.add_argument('--manual-seed', type=int, default=0, metavar='', help='manual seed for randomness')
...
parser.add_argument('--weight-decay', type=float, default=0.0, metavar='', help='weight decay')
